...
public class AppiumTest {
    ...
    public void teamSection_displaysTeams() {
        try {
            // Search for 'Team Alpha' and verify it is displayed
            WebElement team_name = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Team Alpha\"]"));
            Assert.assertTrue(team_name.isDisplayed(), "Team name is not visible!");

            // Search for the number of team members of 'Team Alpha' and verify it is displayed
            WebElement team_members = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"2 members\"]"));
    ...
    public void taskStatusChips_areCorrectlyDisplayed() {
        try {
            ...
            WebElement task_status2 = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Late\"]"));
    ...
    public void teamCard_clickTriggersNavigation() {
        try {
            // Search for 'Team Alpha' and open it (by clicking on it)
            WebElement team_name = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Team Alpha\"]"));
            Assert.assertTrue(team_name.isDisplayed(), "Team name is not visible!");
            team_name.click();
            ...
            // Search for the title 'Team Alpha' and the create task fab, and verify they are displayed
            WebElement team_name_title = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Team Alpha\"]"));
    ...
    public void teamCard_showsCorrectMemberCount() {
        try {
            // Search for the team members of the first team, verify it is displayed and correct
            WebElement team_members = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"2 members\"]"));
            Assert.assertTrue(team_members.isDisplayed(), "Team members is not visible!");

            // Search for the team members of the second team, verify it is displayed and correct
            WebElement team_members2 = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"4 members\"]"));
    ...
    public void teamPager_swipeUpdatesSelectedTeam() {
        ...
        try {
            ...
            while (driver.findElements(AppiumBy.xpath("//android.widget.TextView[@text=\"Last task\"]")).isEmpty() && swipes < maxSwipes) {
                swipeLeft(teams_view_xpath);
                swipes++;
            }

            // Verify the first task of the searched team is visible
            WebElement task_searched = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Last task\"]"));
